...
//     if (!data) {
//       return reply.code(400).send('<div class="status error">No file provided</div>');
//     }
...
//         fetch('${signedUrl}', {
//           method: 'PUT',
//           body: document.querySelector('#fileInput').files[0],
//           headers: {
...
//     reply.code(500).send('<div class="status error">Failed to generate upload URL</div>');
//   }
// });
